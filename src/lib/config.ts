...
export const PRODUCTS = [
  { name: 'Fireside Soy Candle', price: '$28', category: 'Candles', image: 'https://images.unsplash.com/photo-1572726431084-1e3fad024e09?w=500&q=80', description: 'Woodsmoke, amber, and vanilla. 60-hour burn. Hand-poured soy wax.' },
  ...
  { name: 'Gift Box — Self Care', price: '$72', category: 'Gifts', image: 'https://images.unsplash.com/photo-1600428877878-1a0ff561571c?w=500&q=80', description: 'Lavender candle + both soaps + room spray + beeswax wraps. Ribbon-tied.' },
]
