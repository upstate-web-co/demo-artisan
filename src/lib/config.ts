...
export const PRODUCTS = [
  { name: 'Fireside Soy Candle', price: '$28', category: 'Candles', image: 'https://images.unsplash.com/photo-1602607712066-63af5c8a489c?w=500&q=80', description: 'Woodsmoke, amber, and vanilla. 60-hour burn. Hand-poured soy wax.' },
  ...
  { name: 'Beeswax Wrap Set', price: '$22', category: 'Home', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=500&q=80', description: 'Set of 3 reusable food wraps. Local beeswax, organic cotton, jojoba oil.' },
  { name: 'Gift Box — The Essentials', price: '$58', category: 'Gifts', image: 'https://images.unsplash.com/photo-1549465220-1a8b9238f64e?w=500&q=80', description: 'Fireside candle + Honey Oat soap + Linen spray. Gift-wrapped.' },
