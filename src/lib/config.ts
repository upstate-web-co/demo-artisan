...
export const PRODUCTS = [
  { name: 'Fireside Soy Candle', price: '$28', category: 'Candles', image: 'https://images.unsplash.com/photo-1602028915047-37269d1a73f7?w=500&q=80', description: 'Woodsmoke, amber, and vanilla. 60-hour burn. Hand-poured soy wax.' },
  ...
  { name: 'Gift Box — Self Care', price: '$72', category: 'Gifts', image: 'https://images.unsplash.com/photo-1543332164-6e82f355badc?w=500&q=80', description: 'Lavender candle + both soaps + room spray + beeswax wraps. Ribbon-tied.' },
]
